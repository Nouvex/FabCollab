  ...
  return (
    <div className="forum">
      ...
      <div className="content">
        ...
        <div className="info">
          <h2>Praxis Mustermann für Psychische Therapie</h2>
          <p><strong>Beschreibung:</strong> Therapist for Mental Health Problems and Depression</p>
          ...
          <p><strong>Terminbuchung:</strong> Online, Telefonisch</p>
        </div>
      </div>
     ...
     <div className="pros-and-cons">
        <div className="pros">
          ...
          <ul>
            ...
            {/* Weitere Pros können hier hinzugefügt werden */}
          </ul>
        </div>
        <div className="cons">
          <h3>Contras</h3>
          <ul>
            ...
            {/* Weitere Cons können hier hinzugefügt werden */}
          </ul>
        </div>
      </div>
